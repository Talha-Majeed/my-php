...
<div class="container">
    ...
    <form method="post" action="">
        <div class="form-group">
            ...
            <input type="text" name="pagetitle" class="form-control" id="exampleFormControlInput1" placeholder="Page Title" Value="<?php echo $row['page_id']; ?>">
        </div>

        <div class="form-group">
            <label for="exampleFormControlInput1">Page Content</label>
            <textarea name="pagecontent" class="form-control" id="exampleFormControlTextarea1" rows="3" Value="<?php echo $row['page_des'] ; ?>"></textarea>
        </div>
